<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Crear.aspx.cs" Inherits="HBRPractica.Vistas.Login.Crear" %>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <form runat="server">
                    ...
                    <div class="col-sm-5">
                       <input type="password" class="form-control" id="inputPassword" placeholder="Contraseña" runat="server">
                    </div>
                    </div>
                    <div class="form-group row">
